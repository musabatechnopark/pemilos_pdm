...
<script>
    async function switchonof() {
        ...
        var endpoint = 'https://evotingpdm1.online/sistem/admin/setting.php?action=auto_start'
    ...
    async function start_pemilos() {
        ...
        var endpoint = 'https://evotingpdm1.online/sistem/admin/setting.php?action=start_pemilos'
        var id = document.querySelector('#id').value;
        var start_pemilos = document.querySelector('#start_pemilos')
