                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row card-title">
                            ...
                            <div class="col">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#pilihancalon">
                                    Tambah
                                </button>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="pilihancalon" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <form action="../sistem/admin/calon.php" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#pilihancalon">Back</button>
