...
$sql = "SELECT * FROM tb_pengguna WHERE pemilos = 'Sudah'";
...
$query = "SELECT * FROM tb_pengguna WHERE pemilos = 'Sudah'";
...
header('Content-Disposition: attachment;filename="user-sudah-pilih.xlsx"');
