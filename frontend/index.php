            ...
            <div class="container h-100">
                ...
                <div class="row d-flex align-items-center justify-content-center text-center h-100">
                    ...
                    <div class="col-md-8 col-lg-7 col-xl-6">
                        <img src="assets/img/logo_musaba.png" id="logo" class="img" alt="Logo Muhammadiyah" />
                    </div>
                        ...
                        <form name="login" action="sistem/auth/login.php" class="mt-2" method="POST">
                            ...
                            <div class="input-group mb-4">
                                ...
                                <div class="form-floating">
                                    <input type="number" id="form1Example13" class="form-control form-control-lg name <?php if (@$_SESSION['error_login']) : ?> is-invalid <?php endif; ?>" name="nbm" placeholder="Masukkan NIS" required autofocus autocomplete=off />
                                    <label for="form1Example13">Masukkan NIS</label>
                                </div>
                            </div>
                            ...
                            <div class="input-group mb-4">
                                ...
                                <div class="form-floating">
                                    <input type="password" id="form2Example23" class="form-control form-control-lg pass <?php if (@$_SESSION['error_login']) : ?> is-invalid <?php endif; ?>" name="password" placeholder="Password" required />
                                    <label for="form2Example23">Password</label>
                                </div>
                                <button type="button" id="toggle-password" class="input-group-text icon-pass"><i id="toggle-visible" class="bi bi-eye-fill"></i></button>
                            </div>
                            
                            <script>
                                const passwordInput = document.getElementById('form2Example23');
                                ...
                                togglePassword.addEventListener('click', function () {
                                    if (passwordInput.type === 'password') {
                                        ...
                                        toggleVisible.classList.replace("bi-eye-fill", "bi-eye-slash-fill")
                                    } else {
                                        passwordInput.type = 'password';
                                        toggleVisible.classList.replace("bi-eye-slash-fill", "bi-eye-fill")
                                    }
                                });
                            </script>       
