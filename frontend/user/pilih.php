...
?>
    ...
    <body>
        <div class="container">
            ...
            <h2 class="mt-5 ijo">Pilihlah 5 dari <?= $jumlah; ?> kandidat di bawah</h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class=" d-grid col-6 mb-5 ms-auto mt-3 ">
                                    <p class=" ijo fw-bold text-end">Anda sudah memilih <span id="total-pilih">0</span>/5</p>
                ...
                function tc<?= $row['id'] ?>() {
                    ...
                    if (Number(a.value) == 0) {
                        if (number >= Number(<?= $data->max_pilih ?>)) {
                            return Swal.fire('anda sudah memilih 5')
                        } else {
                    ...
                    let total = 0; // inisialisasi nilai total dengan 0
                    ...
                    if (Number(total) == Number(<?= $data->max_pilih ?>)) {
                        sub.disabled = false;
                    } else {
                        sub.disabled = true;
                    }
