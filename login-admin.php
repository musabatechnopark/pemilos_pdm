                        ...
                        <form name="login" action="sistem/auth/login.php" class="mt-2" method="POST">
                            ...
                            <div class="input-group mb-4">
                                ...
                                <div class="form-floating">
                                    <input type="text" id="form1Example13" class="form-control form-control-lg name <?php if (@$_SESSION['error_login']) : ?> is-invalid <?php endif; ?>" name="username" placeholder="NBM" required autofocus />
                                    <label for="form1Example13">Username</label>
                                </div>
                            </div>
                            ...
                            <!-- Submit button -->
                            <button type="submit" name="login" value="admin" class="btn btn-primary lebar btn-lg btn-block mt-5">
                                LOGIN
                            </button>
                        </form>
                    </div>
